...
<!-- Welcome Hero -->
<section id="home" class="welcome-hero" style="background: url('assets/images/turkey/konya.jpg') no-repeat center center/cover;">
    <div class="container">
        <div class="welcome-hero-txt">
            <h2>Explore Konya</h2>
            <p>Discover the spiritual heart of Turkey, home of Rumi and the Whirling Dervishes.</p>
        </div>
    ...
    <div class="single-explore-img">
      ...
      <div class="single-explore-img-info">
        ...
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Mevlana Museum', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Mevlana Museum, Konya')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>The tomb of Rumi (Mevlana), founder of the Mevlevi Order, an important spiritual site.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/alaeddin-mosque.jpg" alt="Alaeddin Mosque">
      <div class="single-explore-img-info">
        <button>historic</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Alaeddin Mosque', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Alaeddin Mosque, Konya')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-2">
      <h2><a href="#">Alaeddin Mosque</a></h2>
      <p class="explore-rating-price">
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>Historical mosque from the Seljuk period, built atop Konya's central hill.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/karatay-madrasa.jpg" alt="Karatay Madrasa">
      <div class="single-explore-img-info">
        <button>museum</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Karatay Madrasa', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Karatay Madrasa, Konya')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      <h2><a href="#">Karatay Madrasa</a></h2>
      <p class="explore-rating-price">
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>Beautiful 13th-century school now turned into a museum, famous for its Seljuk tiles.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="reviews" class="reviews">
	<div class="section-header">
		...
		<p>What our clients say about Konya!</p>
	</div>
		...
		<div class="testimonial-carousel">
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Mevlana Müzesi etkileyiciydi. Şehirde manevi bir huzur var."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Konya is calm and full of cultural richness. The Whirling Dervish ceremony was beautiful."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Şehir çok düzenli ve sakin. Etliekmek yemeden dönmeyin!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Very traditional and conservative city, but peaceful and welcoming."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Maneviyat arayanlar için en doğru şehir. Tarih ve huzur bir arada."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Tradiții vii, locuri sfinte și atmosferă deosebită. O experiență aparte."</p>
					</div>
				</div>
			</div>
		...
		<div class="blog-content">
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/konya1.jpg" alt="Mevlana Museum Konya">
						</div>
						<div class="single-blog-item-txt">
							<h2>City of Rumi</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								Konya is the final resting place of Mevlânâ Rumi — the world-renowned Sufi poet and philosopher, honored at the Mevlana Museum.
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/konya2.jpg" alt="Whirling Dervishes Konya">
						</div>
						<div class="single-blog-item-txt">
							<h2>Whirling Dervishes</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								Konya is the spiritual home of the Whirling Dervishes — where the mesmerizing Sema ceremony takes place in honor of Rumi's legacy.
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/konya3.jpg" alt="Konya ancient history">
						</div>
						<div class="single-blog-item-txt">
							<h2>One of the world’s oldest cities</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> may 2025</h4>
							<p>
								Konya’s history stretches back to Neolithic times — including Çatalhöyük, one of the earliest urban settlements in human history.
							</p>
						</div>
					</div>
				</div>
