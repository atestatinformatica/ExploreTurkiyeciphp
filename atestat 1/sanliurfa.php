...
<!-- Welcome Hero -->
<section id="home" class="welcome-hero" style="background: url('assets/images/turkey/sanliurfa.jpg') no-repeat center center/cover;">
    <div class="container">
        <div class="welcome-hero-txt">
            <h2>Explore Sanliurfa</h2>
            <p>Discover the city of prophets, ancient history, and vibrant culture in Sanliurfa.</p>
        </div>
...
<!-- 1. Balıklıgöl (Pool of Sacred Fish) -->
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/balikligol.jpg" alt="Balıklıgöl">
      <div class="single-explore-img-info">
        <button>spiritual</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Balikligol', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Balikligol, Sanliurfa')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      <h2><a href="#">Balıklıgöl (Pool of Sacred Fish)</a></h2>
      <p class="explore-rating-price">
        <span class="explore-rating">5.0</span>
        <a href="#">420 ratings</a>
        <span class="explore-price-box">price: <span class="explore-price">Free</span></span>
        <a href="#">Sacred Site</a>
      </p>
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>Legendary pool where Prophet Abraham is believed to have been saved from fire; sacred carp swim here.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/gobekli-tepe.jpg" alt="Göbekli Tepe">
      <div class="single-explore-img-info">
        <button>archaeology</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Gobekli Tepe', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Gobekli Tepe, Sanliurfa')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-2">
      <h2><a href="#">Göbekli Tepe</a></h2>
      <p class="explore-rating-price">
        <span class="explore-rating">5.0</span>
        <a href="#">350 ratings</a>
        <span class="explore-price-box">price: <span class="explore-price">90 TL</span></span>
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>The world's oldest known temple complex, dating back over 11,000 years. A UNESCO World Heritage Site.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/sanliurfa-castle.jpg" alt="Sanliurfa Castle">
      <div class="single-explore-img-info">
        <button>historic</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Sanliurfa Castle', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Sanliurfa Castle')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      <h2><a href="#">Şanlıurfa Castle</a></h2>
      <p class="explore-rating-price">
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10">
            <p>Historic hilltop castle offering panoramic views of Şanlıurfa and nearby sacred sites.</p>
          </div>
        </div>
      </div>
    </div>
...
<section id="reviews" class="reviews">
	<div class="section-header">
		...
		<p>What our clients say about Sanliurfa!</p>
	</div>
		...
		<div class="testimonial-carousel">
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Gölbaşı Parkı'ndaki kutsal balıkları beslemek ve tarihi sokaklarda kaybolmak unutulmazdı!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Balıklıgöl’deki atmosfer büyüleyici. Tarih ve doğa mükemmel birleşmiş!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Göbeklitepe'yi görmeden dönmeyin. Tarihin sıfır noktasında hissetmek inanılmaz."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Kale manzarası harika ama restorasyon nedeniyle içeri giremedik. Yine de fotoğraflar muhteşem!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"Çarşıdaki baharat kokuları ve otantik dükkanlar büyüleyici. Şanlıurfa mutfağı efsane!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					...
					<div class="testimonial-comment">
						<p>"El parque Gölbaşı es un oasis. ¡Las leyendas de los peces sagrados hacen todo más mágico!"</p>
					</div>
				</div>
			</div>
		...
		<div class="blog-content">
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/sanliurfa1.jpg" alt="Gobekli Tepe">
						</div>
						<div class="single-blog-item-txt">
							<h2>World’s oldest temple</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								Located near Şanlıurfa, Göbekli Tepe is over 11,000 years old — older than Stonehenge or the pyramids, and still a mystery!
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/sanliurfa2.jpg" alt="Balikligol Urfa">
						</div>
						<div class="single-blog-item-txt">
							<h2>The sacred fish lake</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								Balıklıgöl (Pool of Sacred Fish) is believed to be where Prophet Abraham was thrown into the fire — and the fire turned to water!
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/sanliurfa3.jpg" alt="Urfa cuisine">
						</div>
						<div class="single-blog-item-txt">
							<h2>Birthplace of kebab culture</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> may 2025</h4>
							<p>
								Şanlıurfa proudly claims to be one of the origins of Turkish kebab — spicy, smoky, and full of flavor. Urfa kebabı is iconic!
							</p>
						</div>
					</div>
				</div>
