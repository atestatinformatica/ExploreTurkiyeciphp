...
function openPopup(imageSrc) {
    document.getElementById("popup-img").src = imageSrc; // Setează sursa imaginii mari
    document.getElementById("popup").style.display = "block"; // Afișează pop-up-ul
}

// Închide fereastra pop-up
function closePopup() {
    document.getElementById("popup").style.display = "none"; // Ascunde pop-up-ul
}
