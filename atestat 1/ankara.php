...
<head>
    <meta charset="utf-8">
    <title>Explore Ankara - ExploreTurkey</title>
...
<!-- Welcome Hero -->
<section id="home" class="welcome-hero" style="background: url('assets/images/turkey/ankara.jpg') no-repeat center center/cover;">
    <div class="container">
        <div class="welcome-hero-txt">
            <h2>Explore Ankara</h2>
            <p>Discover the political heart and cultural treasures of Turkey's capital city.</p>
        </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/anitkabir.jpg" alt="Anıtkabir">
      <div class="single-explore-img-info">
        <button>monument</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Anitkabir', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Anitkabir, Ankara')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      <h2><a href="#">Anıtkabir</a></h2>
      <p class="explore-rating-price">
        <span class="explore-rating">5.0</span>
        <a href="#">350 ratings</a>
      ...
      <div class="explore-person">
        <div class="row">
          ...
          <div class="col-sm-10"><p>The mausoleum of Mustafa Kemal Atatürk, founder of modern Turkey, an iconic site.</p></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/ankara-castle.jpg" alt="Ankara Castle">
      <div class="single-explore-img-info">
        <button>historic</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Ankara Castle', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Ankara Castle, Ankara')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-2">
      <h2><a href="#">Ankara Castle</a></h2>
      <p class="explore-rating-price">
      ...
      <div class="explore-person">
        <div class="row">
          <div class="col-sm-2"><div class="explore-person-img"><a href="#"><img src="assets/images/users/user-placeholder.jpg" alt="User"></a></div></div>
          <div class="col-sm-10"><p>Historic castle offering beautiful panoramic views over Ankara’s old town.</p></div>
        </div>
      </div>
    </div>
  </div>
...
<div class="col-md-4 col-sm-6">
  <div class="single-explore-item">
    <div class="single-explore-img">
      <img src="assets/images/explore/Museum-of-Anatolian-Civilizations.jpg" alt="Museum of Anatolian Civilizations">
      <div class="single-explore-img-info">
        <button>museum</button>
        <div class="single-explore-image-icon-box">
          <ul>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); toggleLike('Museum of Anatolian Civilizations', this.querySelector('i'))"><i class="fa fa-heart-o"></i></a></div></li>
            <li><div class="single-explore-image-icon"><a href="#" onclick="event.preventDefault(); openMap('Museum of Anatolian Civilizations, Ankara')"><i class="fa fa-map-marker"></i></a></div></li>
          </ul>
        </div>
      </div>
    </div>
    <div class="single-explore-txt bg-theme-1">
      <h2><a href="#">Museum of Anatolian Civilizations</a></h2>
      <p class="explore-rating-price">
      ...
      <div class="explore-person">
        <div class="row">
          <div class="col-sm-2"><div class="explore-person-img"><a href="#"><img src="assets/images/users/user-placeholder.jpg" alt="User"></a></div></div>
          <div class="col-sm-10"><p>Amazing collection of prehistoric artifacts from Anatolia, a must-see in Ankara.</p></div>
        </div>
      </div>
    </div>
  </div>
...
<section id="reviews" class="reviews">
	<div class="section-header">
		...
		<p>What our clients say about Ankara!</p>
	</div>
	<div class="reviews-content">
		<div class="testimonial-carousel">
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c1.png" alt="clients"></div>
					...
					<div class="testimonial-comment">
						<p>"Anıtkabir is a must-visit. The city has a calm, organized feel and excellent museums."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c2.png" alt="clients"></div>
						<div class="testimonial-person">
					...
					<div class="testimonial-comment">
						<p>"Clean, modern and full of history. Loved the Rahmi Koç Museum!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c3.png" alt="clients"></div>
						<div class="testimonial-person">
							<h2>Mehmet Öztürk</h2>
							<h4>Ankara</h4>
							<div class="testimonial-person-star">
					...
					<div class="testimonial-comment">
						<p>"Başkent atmosferi, modern cafenele și cartiere curate. Super liniștit!"</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c4.png" alt="clients"></div>
						<div class="testimonial-person">
							<h2>Lina Varga</h2>
							<h4>Ankara</h4>
							<div class="testimonial-person-star">
					...
					<div class="testimonial-comment">
						<p>"I liked the mix between new buildings and historical places. Great local food too."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c5.png" alt="clients"></div>
						<div class="testimonial-person">
							<h2>Ahmad Saeed</h2>
							<h4>Ankara</h4>
							<div class="testimonial-person-star">
					...
					<div class="testimonial-comment">
						<p>"Public transport is excellent. Quiet, elegant city with soul."</p>
					</div>
				</div>
			</div>
			...
			<div class="single-testimonial-box">
				<div class="testimonial-description">
					<div class="testimonial-info">
						<div class="testimonial-img"><img src="assets/images/clients/c6.png" alt="clients"></div>
						<div class="testimonial-person">
							<h2>Daria Novak</h2>
							<h4>Ankara</h4>
							<div class="testimonial-person-star">
					...
					<div class="testimonial-comment">
						<p>"Not as crowded as Istanbul, which I loved. Great place for families and couples."</p>
					</div>
				</div>
			</div>
		...
		<div class="blog-content">
			<div class="row">
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/ankara1.jpg" alt="Anitkabir">
						</div>
						<div class="single-blog-item-txt">
							<h2>Resting Place of Atatürk</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								Anıtkabir in Ankara is the grand mausoleum of Mustafa Kemal Atatürk, founder of modern Turkey.
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/ankara2.jpg" alt="Angora cats">
						</div>
						<div class="single-blog-item-txt">
							<h2>Home of the Angora cats</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> april 2025</h4>
							<p>
								The fluffy, pure white Turkish Angora cat originated in Ankara — once called “Angora”!
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<div class="single-blog-item">
						<div class="single-blog-item-img">
							<img src="assets/images/blog/ankara3.jpg" alt="Museum of Anatolian Civilizations">
						</div>
						<div class="single-blog-item-txt">
							<h2>Cradle of Anatolian heritage</h2>
							<h4>posted <span>by</span> <a href="#admin">admin</a> may 2025</h4>
							<p>
								The Museum of Anatolian Civilizations showcases 10,000+ years of rich Anatolian history.
							</p>
						</div>
					</div>
				</div>
